...
import 'package:flutter_study/wanandroid/utils/CommonUtil.dart';
...
class NavigationScreen extends BaseWidget {
  @override
  BaseWidgetState<BaseWidget> attachState() => _NavigationScreenState();
}
  ...
  Future getNavigationList() async {
    apiService.getNavigationList((NavigationModel navigationModel) {
      if (navigationModel.errorCode == Constants.STATUS_SUCCESS) {
        ...
        showError();
        ToastUtil.show(msg: navigationModel.errorMsg);
      }
    }, (DioError error) {
      showError();
    });
