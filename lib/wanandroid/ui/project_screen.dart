...
import 'package:flutter_study/wanandroid/widgets/item_project_list.dart';
import 'package:flutter_study/wanandroid/widgets/refresh_footer.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';
/// 项目页面
class ProjectScreen extends BaseWidget {
  @override
  BaseWidgetState<BaseWidget> attachState() => _ProjectScreenState();
}

class _ProjectScreenState extends BaseWidgetState<ProjectScreen> with TickerProviderStateMixin{
  ...
  Future getProjectTreeList() async {
    apiService.getProjectTreeList((ProjectTreeModel projectTreeModel) {
      if (projectTreeModel.errorCode == Constants.STATUS_SUCCESS) {
        ...
        showError();
        ToastUtil.show(msg: projectTreeModel.errorMsg);
      }
    }, (DioError error) {
      showError();
    });
...
class ProjectArticleScreen extends StatefulWidget {
  ...
  @override
  _ProjectArticleScreenState createState() => _ProjectArticleScreenState();
}
