...
import 'package:flutter_study/wanandroid/common/router_config.dart' as prefix0;
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: themeData,
      routes: prefix0.Router.generateRoute(),  // 存放路由的配置
  ...
  void registerThemeEvent(){
    Application.eventBus.on<ThemeChangeEvent>().listen((ThemeChangeEvent event){
